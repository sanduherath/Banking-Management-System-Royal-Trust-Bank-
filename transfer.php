...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($amount <= 0) {
        echo "<script>document.addEventListener('DOMContentLoaded', function() { Swal.fire('Error', 'Amount must be greater than 0!', 'error'); });</script>";
        exit;
    }
...
<head>
    ...
    <title>Transfer Funds - Royal Trust Bank</title>
...
<body>
    ...
    <div class="container">
        ...
        <main>
            <section class="transfer-form animate__animated animate__fadeInUp animate__delay-1s">
                <div class="transfer-form-content">
                    <h2>Make a Transfer</h2>
                    
                    <div class="balance-info">
                        Your current balance: <span class="balance-amount">LKR <?php echo number_format($balance, 2); ?></span>
                    </div>
